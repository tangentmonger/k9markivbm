...
def generate_wum(path, n_sounds):
    ...
    for speed in range(1, n_sounds+1):
        ...
        freqCR = [5, 7, 9,15, 21,35, 42, 49, 63][speed] # random.randint(500, 3000) # frequency of the carrier wave (Hz) 
        freqAM = 126 #random.randint(1, 10) # frequency of the AM wave (Hz) 
        freqFM = [5,9,15,21,35, 42, 49][speed] #random.randint(1, 10) # frequency of the FM wave (Hz) 
        freqFMDev = 35 #random.randint(100, 400) # frequency deviation for FM (Hz) 
